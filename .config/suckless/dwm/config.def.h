...
static const char *fonts[]          = { "Hurmit Nerd Font:size=12:antialias=true:autohint=true","Noto Color Emoji:size=12:antialias=true:autohint=true" };
static const char dmenufont[]       = "Hurmit Nerd Font:size=12";
